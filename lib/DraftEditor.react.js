...
function (_React$Component2) {
  ...
  function DraftEditor(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "focus", function (scrollPosition) {
      ...
      !isHTMLElement(editorNode) ? process.env.NODE_ENV !== "production" ? invariant(false, 'editorNode is not an HTMLElement') : invariant(false) : void 0; // Restore scroll position
